...
WebUI.click(findTestObject('button_atc_product_1'))

name = WebUI.getText(findTestObject('name_product_1'))

price = WebUI.getText(findTestObject('price_product_1'))

WebUI.click(findTestObject('icon_cart'))
